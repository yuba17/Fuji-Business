...
@section('title', 'Crear Acción de Mitigación')
    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-3">
        ...
        <li>
            <div class="flex items-center">
                ...
                <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Nueva Acción</span>
            </div>
        </li>
    </ol>
</nav>
...
<div class="mb-8">
    ...
    <p class="text-gray-600 mt-2">Define una acción para mitigar el riesgo: <strong>{{ $risk->name }}</strong></p>
</div>

<x-ui.card>
    <form action="{{ route('risks.mitigation-actions.store', $risk) }}" method="POST" class="space-y-6">
        @csrf
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
                <x-ui.input 
                    ...
                    value="{{ old('expected_probability_reduction') }}"
                    min="0"
                    max="5"
                    placeholder="0-5" />
            </div>
            ...
            <div>
                <x-ui.input 
                    ...
                    value="{{ old('expected_impact_reduction') }}"
                    min="0"
                    max="5"
                    placeholder="0-5" />
            </div>
