...
@section('title', 'Comparar Escenarios - ' . $plan->name)
...
<div class="mb-8">
    ...
    <p class="text-gray-600 mt-2">Compara dos escenarios para evaluar sus diferencias e impactos.</p>
</div>

@livewire('scenarios.scenario-comparison', ['plan' => $plan])
@endsection
