...
@section('title', 'Tablero Kanban de Tareas')
    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-3">
        ...
        <li>
            <div class="flex items-center">
                ...
                <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Kanban</span>
            </div>
        </li>
    </ol>
</nav>
...
<div class="mb-8">
    ...
    <p class="text-gray-600 mt-2">Gestiona tus tareas con drag & drop</p>
</div>

@livewire('tasks.task-kanban', ['planId' => $planId])
@endsection
