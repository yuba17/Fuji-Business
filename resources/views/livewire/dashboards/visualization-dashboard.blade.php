...
<div class="mb-8">
    <div class="bg-gradient-to-r from-indigo-600 via-purple-600 to-indigo-600 rounded-2xl shadow-lg p-8 text-white relative overflow-hidden">
...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
    ...
    <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-purple-500 hover:shadow-lg transition-shadow">
        ...
        <p class="text-4xl font-bold text-gray-900 mb-3">{{ $totalTasks }}</p>
        <div class="flex items-center gap-2">
            <span class="px-3 py-1 bg-purple-100 text-purple-800 text-xs font-semibold rounded-lg">Registradas</span>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-orange-500 hover:shadow-lg transition-shadow">
        ...
        <p class="text-gray-600 text-sm font-medium mb-2">Total Riesgos</p>
        <p class="text-4xl font-bold text-gray-900 mb-3">{{ $totalRisks }}</p>
        <div class="flex items-center gap-2">
