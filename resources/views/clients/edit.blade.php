    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-3">
        ...
        <li>
            <div class="flex items-center">
                ...
                <a href="{{ route('clients.show', $client) }}" class="ml-1 text-sm font-medium text-gray-700 hover:text-red-600 md:ml-2">{{ $client->name }}</a>
            </div>
        </li>
        <li>
            <div class="flex items-center">
    ...
    <form action="{{ route('clients.update', $client) }}" method="POST" class="space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                <x-ui.input 
                    ...
                    value="{{ old('sector_economico', $client->sector_economico) }}"
            ...
            <div>
                <x-ui.input 
                    ...
                    name="tamaño_empresa" 
                    value="{{ old('tamaño_empresa', $client->tamaño_empresa) }}"
        ...
        <div>
            <x-ui.input 
                label="Ubicación" 
                name="ubicacion" 
                value="{{ old('ubicacion', $client->ubicacion) }}"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                <x-ui.input 
                    ...
                    value="{{ old('contacto_principal', $client->contacto_principal) }}"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
                <x-ui.input 
                    ...
                    name="sitio_web" 
                    type="url"
                    value="{{ old('sitio_web', $client->sitio_web) }}"
        ...
        <div>
            <x-ui.textarea 
                ...
                >{{ old('notas', $client->notas) }}</x-ui.textarea>
        </div>
        
        <div class="flex items-center justify-end gap-3 pt-4 border-t border-gray-200">
            <x-ui.button href="{{ route('clients.show', $client) }}" variant="secondary" type="button">
                Cancelar
            </x-ui.button>
