...
use App\Filament\Resources\ToolingAttributes\Attributes\Pages\CreateMilestoneTypeAttribute;
use App\Filament\Resources\ToolingAttributes\Attributes\Pages\EditMilestoneTypeAttribute;
use App\Filament\Resources\ToolingAttributes\Attributes\Pages\ListMilestoneTypeAttributes;
use App\Filament\Resources\ToolingAttributes\Attributes\Pages\ViewMilestoneTypeAttribute;
...
class MilestoneTypeAttributeResource extends Resource
{
    ...
    protected static string $attributeType = 'milestone_type';
    ...
    {
        return [
            'index' => ListMilestoneTypeAttributes::route('/'),
            'create' => CreateMilestoneTypeAttribute::route('/create'),
            'view' => ViewMilestoneTypeAttribute::route('/{record}'),
            'edit' => EditMilestoneTypeAttribute::route('/{record}/edit'),
        ];
    }
}
