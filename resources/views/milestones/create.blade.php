    ...
    <ol class="inline-flex items-center space-x-1 md:space-x-3">
        ...
        <li>
            <div class="flex items-center">
                ...
                <span class="ml-1 text-sm font-medium text-gray-500 md:ml-2">Crear Hito</span>
            </div>
        </li>
    </ol>
</nav>
...
<div class="mb-8">
    ...
    <p class="text-gray-600 mt-2">Define un nuevo hito para el plan: <strong>{{ $plan->name }}</strong></p>
</div>

<x-ui.card>
    <form action="{{ route('plans.milestones.store', $plan) }}" method="POST" class="space-y-6">
        @csrf
