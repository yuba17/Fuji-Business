...
@section('title', 'Crear Escenario - ' . $plan->name)
...
<div class="mb-8">
    ...
    <p class="text-gray-600 mt-2">Simula diferentes situaciones para el plan: <strong>{{ $plan->name }}</strong></p>
</div>

@livewire('scenarios.scenario-builder', ['plan' => $plan])
@endsection
